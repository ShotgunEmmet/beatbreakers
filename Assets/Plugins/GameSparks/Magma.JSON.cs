	...
	public static class JSON
	{
		...
		private class JSONDeserializer
		{
			...
			private string ProcessHashKey()
			{
				...
				string result = json.Substring(startIndex, index - startIndex - 1).TrimEnd();
		...
		/// <returns></returns>
		public static string ChopStart(this string str, string x)
		{
			if (str.StartsWith(x))
		...
		/// <param name="x">The value that needs to be chopped</param>
		/// <returns></returns>
		public static string ChopEnd(this string str, string x)
		{
			if (str.EndsWith(x))
